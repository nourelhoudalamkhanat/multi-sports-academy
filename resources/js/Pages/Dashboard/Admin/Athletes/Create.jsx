        ...
        <DashboardLayout>
            ...
            <div className="max-w-2xl mx-auto">
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl font-bold mt-2" style={{ color: '#0F172A' }}>➕ Ajouter un athlète</h1>
                </div>
                ...
                <form onSubmit={submit} className="bg-white rounded-xl shadow-sm p-8 space-y-6">
                    ...
                    <div className="flex items-center justify-end gap-4 pt-4">
                        <Link href="/admin/athletes" className="px-6 py-3 rounded-lg text-sm font-medium" style={{ color: '#6B7280' }}>
                            Annuler
                        </Link>
                        <button type="submit" disabled={processing}
                            ...
                            {processing ? 'Création...' : 'Créer l\'athlète'}
                        </button>
                    </div>
                </form>
            </div>
